<?php if ( ! fox56() ) { include_once(dirname( __FILE__ ).'/v55/comments.php'); return; } ?>
<?php
...
<div id="comments" class="single56__element comments-area single-section single-component">
    ...
    <h2 class="single56__heading">
        ...
        <a href="#respond"><?php echo fox_word( 'title_reply' ); ?></a>
    </h2><!-- .comments-title -->
    
    <?php fox56_comment_nav( 'above' ); ?>
	...
	$args = array(
        ...
        'title_reply_before'    => '<h3 id="reply-title" class="comment-reply-title single-heading single56__heading">',
