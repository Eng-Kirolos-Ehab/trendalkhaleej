...
if( isset( $instance['text'] ) ) {
  $instance['text'] = apply_filters( 'wpml_translate_single_string', $instance['text'], self::CONTEXT_WPML, $this->field_name_translation( 'text' ) );
}
if( isset( $instance['url'] ) ) {
  $instance['url'] = apply_filters( 'wpml_translate_single_string', $instance['url'], self::CONTEXT_WPML, $this->field_name_translation( 'url' ) );
}
extract( $args );
