<div class="fox-wrap">
    ...
    <div class="wrap about-wrap full-width-layout fox-welcome">
        ...
        <nav class="nav-tab-wrapper wp-clearfix" aria-label="Secondary menu">
            ...
            <a href="https://fox.withemes.com/documentation/" target="_blank" class="nav-tab">Documentation</a>
        ...
        <div class="fox-welcome-board fox-board-registration fox-board">
            ...
            <div class="fox-welcome-board fox-board-links">
                ...
                <ol>
                    ...
                    <li>
                        <a href="https://fox.withemes.com/documentation/" target="_blank">Online Documentation &rarr;</a>
                    </li>
