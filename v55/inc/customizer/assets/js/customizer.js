...
( function( $, api ) {
    ...
    api.bind( 'ready', function() {
         ...
         * @since 4.5
         */
        $( '#customize-info .preview-notice' ).after( '<a href="https://fox.withemes.com/documentation/" target="_blank" class="foxdocs-link">Fox\'s Documentation <i class="dashicons dashicons-external"></i></a>' )
