<?php
/**
 * abstract: everything about sidebar
 * sidebar manager (add new, update, delete sidebars..)
 * sidebar mechanisms
 */
...
class Fox_Sidebar {
    ...
    function replace_sidebar() {
        ...
        if ( is_single() ) {
            ...
            foreach ( $positions as $id => $name ) {
                ...
                if ( ! $custom_sidebar && 'sidebar' == $id ) {
                    
                    $custom_sidebar = get_theme_mod( 'wi_single_sidebar' );
            ...
            foreach ( $positions as $id => $name ) {
                ...
                if ( ! $custom_sidebar && 'sidebar' == $id ) {
                    // custom category
                    if ( is_category() ) {
                        $custom_sidebar = get_theme_mod( 'wi_category_sidebar' );
                    } elseif ( is_tag() ) {
                        $custom_sidebar = get_theme_mod( 'wi_tag_sidebar' );
                    }
            ...
            $custom_sidebar = get_theme_mod( 'wi_author_sidebar' );
            if ( $custom_sidebar && isset( $clone[ $custom_sidebar ] ) ) {
                $_wp_sidebars_widgets[ 'sidebar' ] = $clone[ $custom_sidebar ];
            }
        } elseif ( is_search() ) {
            $custom_sidebar = get_theme_mod( 'wi_search_sidebar' );
            if ( $custom_sidebar && isset( $clone[ $custom_sidebar ] ) ) {
                $_wp_sidebars_widgets[ 'sidebar' ] = $clone[ $custom_sidebar ];
            }
        } elseif ( is_archive() ) {
            $custom_sidebar = get_theme_mod( 'wi_archive_sidebar' );
            if ( $custom_sidebar && isset( $clone[ $custom_sidebar ] ) ) {
                $_wp_sidebars_widgets[ 'sidebar' ] = $clone[ $custom_sidebar ];
            }
        }
    ...
    public function create_admin_page() {
        ...
        <div class="wrap">
            ...
            <div class="fox-wrap">
                ...
                <div class="fox-wrapper" style="max-width:800px;">
    ...
    function get_sidebars() {
        ...
        $sidebars = get_theme_mod( 'fox_sidebars' );
    ...
    function update_sidebars( $sidebars ) {
        ...
        $update = set_theme_mod( 'fox_sidebars', $sidebars );
    ...
    public function process_sidebar() {
        ...
        if ( 'add' == $action_type ) {
            ...
            $sidebar_slug = sanitize_title( $sidebar_slug );
...
/*
 * Displays sidebar if sidebar_state returns true
 * @since 4.0
 * ------------------------------------------------------------------ */
